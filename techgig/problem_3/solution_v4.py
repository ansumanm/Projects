...
# Evaluate min effort
def effort_compute_fn(input_tuple):
    ...
    selector_tuple, effort_tuple = input_tuple

    # selector_tuple, effort_tuple
    """
...
def main():
    ...
    effort_list_perm = permutations(efforts_list, D)
    ...
    for eff in map(effort_compute_fn, product(doctors_filtered_combination, effort_list_perm)):
        if eff < min_effort:
            min_effort = eff
    ...
    print("effort_compute_fn called %d times " % counter)
